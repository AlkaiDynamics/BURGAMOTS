...
const fixtures = {
  ...
  'analysis-result.schema.json': { schemaVersion:'1.0.0', resultId:'res1', hypothesisId:'burgamots-original-purpose', status:'BLOCKED', fixture:false, datasetManifestId:null, evaluationBoundaryId:null, analysisConfigId:null, runMetadataId:null, method:null, seed:null, sample:{ n:null, independentN:null }, estimate:null, uncertainty:null, pValue:null, multiplicity:null, limitations:['blocked'], evidenceRefs:[], reviewEvidenceRefs:[] },
