"""Candidate coefficient-space Casimir centering for BURGAMOTS numerics.

This module is isolated on gate/coefficient-centered-casimir until the binary
amendment gate passes. It does not alter the continuum state: H_h remains the
evolved thickness field. eta_h is a deterministic derived DG1 field.

The background field H0_h must live in the same DG1 space as H_h and be filled
by exact FE coefficient assignment. eta_h is then formed coefficient-wise.
"""
